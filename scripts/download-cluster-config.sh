...
then
    ...
    echo "Please, define it with the cluster id of the Terraform output in the form of 'c-hmmwr'."
...
echo "SUCCESS. "
echo
echo "Use 'kubectl get nodes' to check your cluster"
echo
